...
from retrospective_intake_gate_util import find_retro_intake_gate_sub  # noqa: E402
...
def main() -> int:
    ...
    token = get_token()
    sub = find_retro_intake_gate_sub(args.parent, token)
    ...
    if sub is None:
        ...
        if args.json:
            ...
            print(
                console_safe(
                    "SKIP  retro_intake_gate  reason=no_gate_sub  (opt-out default OK)"
                )
            )
        return 0
