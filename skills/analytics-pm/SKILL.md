...
```powershell
.\.venv\Scripts\python.exe .\skills\asana-buddy\optional\comment_task.py --gid <子GID> --agent analytics-pm --skill skills/analytics-pm/SKILL.md --summary "子タスク完了" --body "..." -y
...
完了時: `DeptWorkComplete`（`department: analysis`）— [`schemas/dept-work-complete.v1.schema.json`](../product-manager/schemas/dept-work-complete.v1.schema.json)
