...
4. Handoff を `output/planning/handoff/*.json`、レビューを `output/planning/plan-review/*.json` に保存
...
3. dispatcher → 課 workflow（開発課は [`product-manager`](../../development/product-manager/SKILL.md)）
