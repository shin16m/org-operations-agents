...
| [`platform/handoff/`](platform/handoff/) | 統括グループ整備エピック例 · notes 二層 fixture |
| [`audit/reports/`](audit/reports/) | ConsistencyAuditReport fixture |
| [`audit/reviews/`](audit/reviews/) | AuditReviewResult fixture |

参照: [`../cross-team/all-teams-dryrun.md`](../cross-team/all-teams-dryrun.md) · [`../planning/planning-dept-v3-dryrun.md`](../planning/planning-dept-v3-dryrun.md) · [`../planning/team-label-e2e-dryrun.md`](../planning/team-label-e2e-dryrun.md)
