...
| 段階 | ファイル |
|------|----------|
| bootstrap Handoff | `output/planning/handoff/bootstrap.planning-dept-v3-dryrun.json` |
| 本番 Handoff | `output/planning/handoff/handoff.planning-dept-v3-dryrun.json` |
| PlanReviewResult | `output/planning/plan-review/plan-review.planning-dept-v3-dryrun.json` |
